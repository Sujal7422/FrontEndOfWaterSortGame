...
<div className="flex items-center justify-center min-h-screen bg-[rgb(42,30,68)]">
  <div className="w-[470px] relative scale-90 hover:scale-100 transition-all duration-500">
    {/* Outer glowing border layers */}
    <div className="absolute top-6 left-6 w-full h-full border-[3px] border-[rgb(50,110,180)] rounded-lg z-0 transition-all duration-500 group-hover:top-0 group-hover:left-0"></div>
    <div className="absolute top-12 left-12 w-full h-full border border-[rgb(50,110,180)] rounded-lg z-0 transition-all duration-500 group-hover:top-0 group-hover:left-0"></div>
